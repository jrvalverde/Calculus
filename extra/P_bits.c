...
/*==========================================================================*/
/* bit_vector bv_new(bits)       Create a new bit vector and set to zeros   */
/*  Reserve the memory space needed for the bit vector      	    	    */
/*  Input:  size in bits of the vector	    	    	    	    	    */
/*  Output: a new bit vector, or NULL if there is not enough memory 	    */
/*==========================================================================*/
...
/*======================================================================
 * void bv_fill(bv, value)  	Flush the vector with a given value.
 *
...
/*===================================================================
 * void bv_set(bv, bitnum)		set specified bit
 *===================================================================*/
void bv_set(bv, bitnum)
/* Inputa */
bit_vector bv;			/* Apuntador al vector de bits */
...
/*=====================================================================
 * bv_test(bv, bitnum)		Test specified bit
 *=====================================================================*/
